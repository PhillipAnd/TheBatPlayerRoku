...
Function DrawScreen()
  ...
  if NowPlayingScreen.screen = invalid
    ...
    if NowPlayingScreen.PopularityImage <> invalid AND NowPlayingScreen.artistimage <> invalid
      NowPlayingScreen.screen.DrawObject(ResolutionX(NowPlayingScreen.artistimage.horizontalOffset + 114), ResolutionY(NowPlayingScreen.artistimage.verticalOffset + NowPlayingScreen.artistimage.height + 97), NowPlayingScreen.PopularityImage, &hFFDDDD55)
    end if
