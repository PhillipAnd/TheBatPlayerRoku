...
' Sub GetMobileLastFMSession(username as String, password as String) as string
'     request = CreateObject("roUrlTransfer")

' 	api_key = "b6153d6e1039f86e308a79531f7c4b6f"
' 	api_secret = "6ee44c8b24093c67dbe7f66aa82827e9"
	
' 	api_sig_unsigned = "api_key" + api_key + "methodauth.getMobileSession" + "password" + password + "username" + username + api_secret
' 	print "Unsigned sig: " + api_sig_unsigned

' 	api_sig = makemdfive(api_sig_unsigned)

' 	url = "https://ws.audioscrobbler.com/2.0/?method=auth.getMobileSession&format=json"
' 	print "url: " + url
...
' 	if (request.AsyncPostFromString("api_key=" + api_key + "&username=" + username + "&password=" + password + "&api_sig=" + api_sig))
' 	    while true
' 	        msg = wait(0, port)
' 	        print msg.GetString()
...
' 	            	print jsonObject.session.key
' 	            	return jsonObject.session.key
' 	            endif
' 	        else
' 	            request.AsyncCancel()
' 	        endif
